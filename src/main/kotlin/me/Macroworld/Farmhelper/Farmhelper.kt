...
import java.net.URI
        ...
        val logger: Logger = LogManager.getLogger("Farmhelper")
        var devMode = false

        val keybinds = hashSetOf<GuiItemSwap.Keybind>()
        val giftAura = KeyBinding("Gift Aura", Keyboard.KEY_NONE, "Farmhelper")
        val playGuiRecorder = KeyBinding("Play gui recorder", Keyboard.KEY_NONE, "Farmhelper")
